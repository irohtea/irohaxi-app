    ...
    <main class="wrapper">
        <div class="wrapper__container">
            <div class="wrapper__group">
                <h2 class="wrapper__title">Albums</h2>
                <div class="wrapper__dropdown">
                    <button class="wrapper__dropdbtn">More..</button>
            ...
            <div class="tack__wrapper">
                <div class="album__tracks album-tracks">
                    <h2 class="track__title">Tracks</h2>
                    <Carousel
                    :value="ourTracks"
                    :numVisible="3"
                    :numScroll="1"
                    ...
                    :showIndicators="false"
                    style="max-width: 100%; margin: 10px 0px 0px 0px"
                    class="carousel-track"
                    >
                        <template #item="slotProps">
                            <div class="track" @click="$store.dispatch('player/addToPlayList', slotProps.data.track)">
