    ...
    <div class="main-page">
        ...
        <form class="main-page__fields main-page__container" @submit.prevent="updateProfile" v-else>
            ...
            <div class="main-page__body">
                ...
                <div class="field__second-column">
                    <div class="field__email field-size">
                    ...
                    <div class="field__number field-size">
            ...
            <div>
                <button class="main-page__button">Update</button>
            </div>
        </form>
    </div>
</template>
